...
const projectsData = [
  ...
  },
  {
    ...
    title: 'E.V.H',
    description:
      'Electric Charger Hub Manager is a multi-platform app designed to assist technicians with the setup, repair, and maintenance of electric vehicle charging hubs. It offers guided installation steps, real-time diagnostics, and quick troubleshooting tools to ensure efficient service and optimal hub performance.',
    detailedDescription:
      'E.V.H (Electric Vehicle Hub) is a comprehensive multi-platform application designed specifically for technicians working with electric vehicle charging infrastructure. The application provides step-by-step installation guides, real-time diagnostic capabilities, maintenance schedules, and troubleshooting tools to ensure optimal performance of charging hubs.',
    imgPath: evh,
    images: [evh], // Add more images here when available
    ghLink: 'https://github.com/oookbaaa/PI_java/tree/User',
    demoLink: null,
    technologies: ['Java', 'JavaFX', 'SQL', 'Apache Maven','FlutterFlow','Symphony','PHP','Stripe'],
    features: [
      'Installation Guides',
  ...
  },
  {
    ...
    demoLink: 'https://skilly-exchange.vercel.app',
    technologies: [
      'Node.js',
      'Nest.js',
      'React',
